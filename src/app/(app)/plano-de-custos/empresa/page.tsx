...
import { ModelosMercado, type ModeloMercado } from "./modelos-mercado";
...
export default async function CustosEmpresaPage({
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-[13px] text-text-muted">
            Custos compartilhados, não ligados a um produto específico —
            contador, jurídico, escritório, infra cloud, gateway de pagamento.
            Entram uma vez no EBITDA consolidado (visto em Relatórios), sem
            ratear entre produtos — o que é rateado por produto são só os custos
            diretos, como horas dedicadas em Equipe Alocada.
          </p>
        </div>
      ...
      <div className="mb-5">
        <ModelosMercado
          modelos={(modelos ?? []) as unknown as ModeloMercado[]}
