      ...
      >
        ...
        <div>
          ...
          <input
            ...
            type="text"
            className="input"
            placeholder="O que esse produto faz"
          />
        </div>
        ...
        <p className="rounded-lg border border-border-soft bg-bg px-3 py-2 text-[11px] text-text-muted">
          Nasce como <strong>planejado</strong> e disponível para qualquer
          cenário. O Base passa a incluí-lo quando você aprová-lo
          {cenarioNome ? `; em ${cenarioNome} ele já entra na seleção` : ""}.
        </p>
