      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="max-w-xl">
          ...
          <p className="mt-1 text-[11.5px] text-text-muted">
            Primeira aba com os indicadores que a banca usa pra decidir (ARR, margem bruta, preço médio de venda, CAC, LTV:CAC,
            payback do CAC, churn, queima de caixa, burn multiple, Regra dos 40, TIR e retorno do capital novo) e o uso do recurso
            pelo orçamento proposto; depois o resumo por ano com EBITDA consolidado
        ...
        <form method="get" action={`/plano/${cenarioId}/investidor/export`} className="flex flex-col gap-2">
          ...
          <span className="text-[11px] font-medium text-text-muted">
            Foco do investimento{origemFoco && <span className="font-normal text-text-faint"> — marcado conforme {origemFoco}</span>}
          </span>
